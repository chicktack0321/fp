...
final class MasteryBreakdownTests: XCTestCase {
    ...
    func testSnapshotCountsByField() {
        ...
        XCTAssertEqual(byField[.lifePlanning], 8)
        XCTAssertEqual(byField[.financialAssets], 7)
        XCTAssertEqual(byField[.realEstate], 5)
    }
    ...
    func testSnapshotCountsOnlyQuestionsThatStillExist() {
        let question = makeQuestion("FPTEST_PENSION_0001", midCategory: .publicPension, difficulty: .standard)
        ...
        let orphan = repository.progress(for: "FPTEST_PENSION_9999")
