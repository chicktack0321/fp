...
final class SpacedRepetitionTests: XCTestCase {
    ...
    func testInitialStatusIsNotStudied() {
        let progress = UserProgress(questionId: "FPTEST_PENSION_0001")
    ...
    func testNextReviewIsRoundedToDay() {
        let morning = UserProgress(questionId: "FPTEST_PENSION_0001")
        let night = UserProgress(questionId: "FPTEST_PENSION_0002")
