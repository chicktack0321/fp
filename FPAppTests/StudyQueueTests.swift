...
final class StudyQueueTests: XCTestCase {
    ...
    private func makeQuestion(_ id: String, midCategory: MidCategory = .publicPension) -> QuestionMaster {
    ...
    func testPriorityOrder() {
        ...
        let due = makeQuestion("FPTEST_PENSION_0001")
        let unstudied = makeQuestion("FPTEST_PENSION_0002")
        let scheduled = makeQuestion("FPTEST_PENSION_0003")
    ...
    func testScheduledQuestionsSortedByDueDate() {
        ...
        let soon = makeQuestion("FPTEST_PENSION_0001")
        let later = makeQuestion("FPTEST_PENSION_0002")
    ...
    func testProgressWithoutScheduleIsTreatedAsDue() {
        let now = date(2026, 4, 10)
        let question = makeQuestion("FPTEST_PENSION_0001")
        let unstudied = makeQuestion("FPTEST_PENSION_0002")
    ...
    func testDueCountMatchesDueQuestions() {
        ...
        let due1 = makeQuestion("FPTEST_PENSION_0001")
        let due2 = makeQuestion("FPTEST_PENSION_0002")
        let notDue = makeQuestion("FPTEST_PENSION_0003")
        let unstudied = makeQuestion("FPTEST_PENSION_0004")
    ...
    func testSelectPreservesGivenOrder() {
        let q1 = makeQuestion("FPTEST_PENSION_0001")
        let q2 = makeQuestion("FPTEST_SOCINS_0001", midCategory: .socialInsurance)
        let q3 = makeQuestion("FPTEST_TRUST_0001", midCategory: .investmentTrust)
    ...
    func testSelectSkipsUnknownIds() {
        ...
        let selected = StudyQueue.select(
            questionIds: ["FPTEST_PENSION_9999", q1.questionId],
            from: [q1]
        )
